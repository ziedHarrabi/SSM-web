 ...
 function afficher(x) {
    if (x == "") {
       ...
       document.getElementById("txt").innerHTML = this.responseText;
        ...
        xmlhttp.open("GET","ajaxemp.php?cin="+x,true);
        xmlhttp.send();
    }
}
</script>
                          ...
                          <div id="pay-invoice">
                              <div class="card-body">
                                  <div class="card-title">
                                      <h3 class="text-center">MISE A JOUR EMPLOYES</h3>
                                  </div>
                                  <hr>
                                     
                                      <div class="form-group">
                                        <select class="form-control" onchange="afficher(this.value)">
										<option>Sélectionner une matricule de l'employé</option>
										<?php
									...
									<div id="txt">Les informations de l'employé seront listées ici ..</div>
                              </div>
                          </div>
