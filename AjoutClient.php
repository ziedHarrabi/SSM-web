                  ...
                  <div class="col-lg-9">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Espace Client</strong>
                        </div>
                        <div class="card-body">
                          <!-- Credit Card -->
                          <div id="pay-invoice">
                              <div class="card-body">
                                  <div class="card-title">
                                      <h3 class="text-center">AJOUT CLIENT</h3>
                                  </div>
                                  <hr>
                                  <form action="addclt.php" method="post" novalidate="novalidate">
                                      ...
                                      <div class="form-group has-success">
                                          <label for="cc-name" class="control-label mb-1">Nom Client</label>
                                          <input id="name" name="name" type="text" class="form-control cc-name valid" autocomplete="cc-name" >
                                          <span class="help-block field-validation-valid" data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
                                      </div>
                                      <div class="form-group">
                                          <label for="cc-number" class="control-label mb-1">Téléphone Client</label>
                                      ...
                                      <div class="row">
                                          <div class="col-6">
                                              <div class="form-group">
                                                  <label for="cc-exp" class="control-label mb-1">Adresse Client</label>
                                                  <input id="adr" name="adr" type="text" class="form-control cc-exp" value="" data-val="true" >
