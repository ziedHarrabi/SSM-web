                          ...
                          <div id="pay-invoice">
                              <div class="card-body">
                                  <div class="card-title">
                                      <h3 class="text-center">EMPLACEMENT CLIENTS</h3>
                                  </div>
                                  <hr>
...
$geocode = file_get_contents('http://maps.google.com/maps/api/geocode/json?address='.$a.'&sensor=false');
...
$long = $output->results[0]->geometry->location->lng;
	...
	?>
	var x=new google.maps.LatLng(<?php echo $lat; ?>,<?php echo $long; ?>);
	
  var marker = new google.maps.Marker({position:x, size:new google.maps.Size(2, 2) ,title:"<?php echo $nom." ".$tel; ?>"});
  marker.setMap(map);
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDILUesqhgUhSSqv79zf3d6RNy7hp2bojs&callback=myMap"></script>
