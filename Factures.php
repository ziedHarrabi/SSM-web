...
<body>
  ...
  <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="AjoutFacture.php">Réclamations Client</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="Factures.php">Réclamations Employé</a></li>
                        </ul>
                    </li>
    ...
    <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
					...
					<?php
										...
										$res=mysqli_query($con,"select * from facture");
